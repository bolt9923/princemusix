...
BOT_NAME = getenv("BOT_NAME", "ᴘʀɪᴍᴇ x ᴍᴜsɪᴄ")
ASSUSERNAME = getenv("ASSUSERNAME", "Deviilop")
EVALOP = list(map(int, getenv("EVALOP", "5487734890").split()))
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/bolt9923/princemusix")
